...
let expName = 'Loss Aversion Task';  // from the Builder filename that created this script
...
psychoJS.start({
  ...
  expInfo: expInfo,
  resources: [
    {'name': 'Image/LA.PNG', 'path': 'Image/LA.PNG'},
    {'name': 'Image/Figure_Left.png', 'path': 'Image/Figure_Left.png'},
    {'name': 'Image/Figure_Right.png', 'path': 'Image/Figure_Right.png'},
...
async function experimentInit() {
  ...
  inst_img = new visual.ImageStim({
    ...
    image : 'Image/LA.PNG', mask : undefined,
  ...
  Choice_Left = new visual.ImageStim({
    ...
    image : 'Image/Figure_Left.png', mask : undefined,
  ...
  Choice_Right = new visual.ImageStim({
    ...
    image : 'Image/Figure_Right.png', mask : undefined,
    ori : 0.0, pos : [0.35, 0], size : [0.5, 0.5],
    color : new util.Color([1,1,1]), opacity : undefined,
    flipHoriz : false, flipVert : false,
  ...
  Text_RightU = new visual.TextStim({
    win: psychoJS.window,
    name: 'Text_RightU',
    text: '',
    font: 'Malgun Gothic',
    units: undefined, 
    pos: [0.22, 0], height: font_size,  wrapWidth: undefined, ori: 0.0,
    color: new util.Color('black'),  opacity: undefined,
    depth: -5.0 
  });
  
  Text_RightL = new visual.TextStim({
    win: psychoJS.window,
    name: 'Text_RightL',
    text: '',
    font: 'Malgun Gothic',
    units: undefined, 
    pos: [0.48, 0], height: font_size,  wrapWidth: undefined, ori: 0.0,
    color: new util.Color('black'),  opacity: undefined,
    depth: -6.0 
  });
...
function PayOffRoutineBegin(snapshot) {
  return async function () {
    ...
    txt_rightU = (((s_payoff1.toString() + "\uc6d0") + "\n") + "50%");
    txt_rightL = (((("+" + s_payoff2.toString()) + "\uc6d0") + "\n") + "50%");
    ...
    PayOffComponents.push(Text_RightU);
    PayOffComponents.push(Text_RightL);
...
function PayOffRoutineEachFrame() {
  return async function () {
    ...
    // *Text_RightU* updates
    if (t >= 0.0 && Text_RightU.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Text_RightU.tStart = t;  // (not accounting for frame time here)
    ...
    // *Text_RightL* updates
    if (t >= 0.0 && Text_RightL.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      Text_RightL.tStart = t;  // (not accounting for frame time here)
