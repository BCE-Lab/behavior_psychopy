...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Seongbin Park\\Downloads\\risk_gain\\risk_aversion_gain.py',
...
inst_img = visual.ImageStim(
    win=win,
    name='inst_img', 
    image='Image/instruction_LA.png', mask=None,
...
Choice_Cursor = visual.ImageStim(
    win=win,
    name='Choice_Cursor', 
    image='Image/Figure_Cursor.png', mask=None,
...
instructionComponents = [inst_img, inst_mouse]
